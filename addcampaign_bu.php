...
if ($flag) {
    ...
    if ($result) {
        ...
        $startDate = $campaignData{'start_date'};//[2];
        $endDate = $campaignData{'end_date'};//[3];
                ...
                <div class="yui-g">
                    ...
                    <form id="add" name="add" action="insert_campaign.php" method="post">
                        <div class="content-table">
                            ...
                            <div>
                                <?php if (isset($_SESSION['edit_flag'])) { ?>
                                    <b>Campaign Name</b> &#x00bb; Edit External Links &#x00bb; Edit Content Block &#x00bb; Edit Articles
                                <?php } else { ?>
                                    <b>Campaign Name</b> &#x00bb; Enter External Links &#x00bb; Content Block &#x00bb; Add Articles
                                <?php } ?>
                            </div>
